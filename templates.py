...
<body>
    <div class="container">
        ...
        <div class="toolbar-strip">
            ...
            <div class="toolbar-divider"></div>
            <a class="toolbar-btn" href="#" onclick="window.scrollTo({{top:0,behavior:'smooth'}});return false;" title="Summary"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="5" height="5" rx="1"/><rect x="9" y="2" width="5" height="5" rx="1"/><rect x="2" y="9" width="5" height="5" rx="1"/><rect x="9" y="9" width="5" height="5" rx="1"/></svg></a>
            <a class="toolbar-btn" href="#" onclick="document.getElementById('sectionFilters').scrollIntoView({{behavior:'smooth'}});return false;" title="Filters"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h12M4 6h8M6 9h4M7 12h2"/></svg></a>
            <a class="toolbar-btn" href="#" onclick="document.getElementById('sectionCharts').scrollIntoView({{behavior:'smooth'}});return false;" title="Charts"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="8" width="3" height="6"/><rect x="6.5" y="4" width="3" height="10"/><rect x="11" y="2" width="3" height="12"/></svg></a>
            <a class="toolbar-btn" href="#" onclick="document.getElementById('sectionTable').scrollIntoView({{behavior:'smooth'}});return false;" title="Data Table"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="12" height="12" rx="1"/><line x1="2" y1="6" x2="14" y2="6"/><line x1="2" y1="10" x2="14" y2="10"/><line x1="6" y1="2" x2="6" y2="14"/></svg></a>
            <a class="toolbar-btn" href="#" onclick="document.getElementById('sectionMonthly').scrollIntoView({{behavior:'smooth'}});return false;" title="Monthly Summary"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="12" height="12" rx="1"/><line x1="5" y1="2" x2="5" y2="5"/><line x1="11" y1="2" x2="11" y2="5"/><line x1="2" y1="6" x2="14" y2="6"/><circle cx="5" cy="9" r="0.5" fill="currentColor"/><circle cx="8" cy="9" r="0.5" fill="currentColor"/><circle cx="11" cy="9" r="0.5" fill="currentColor"/><circle cx="5" cy="12" r="0.5" fill="currentColor"/><circle cx="8" cy="12" r="0.5" fill="currentColor"/></svg></a>
            <a class="toolbar-btn" href="#" onclick="document.getElementById('sectionProjects').scrollIntoView({{behavior:'smooth'}});return false;" title="Project Details"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4h3l2-2h5l2 2h0v9a1 1 0 01-1 1H3a1 1 0 01-1-1V4z"/></svg></a>
        </div>
