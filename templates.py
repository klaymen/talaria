...
<body>
  <nav class="sidebar" id="sidebar" aria-label="Main navigation">
    <div class="sidebar-top">
      ...
      <button class="nav-item" data-target="sectionFilters" data-tip="Filters" aria-label="Scroll to filters">
      ...
      <button class="nav-item" data-target="sectionCharts" data-tip="Charts" aria-label="Scroll to charts">
      ...
      <button class="nav-item" data-target="sectionTable" data-tip="Data Table" aria-label="Scroll to data table">
      ...
      <button class="nav-item" data-target="sectionMonthly" data-tip="Monthly Summary" aria-label="Scroll to monthly summary">
      ...
      <button class="nav-item" data-target="sectionProjects" data-tip="Project Details" aria-label="Scroll to project details">
    ...
    <div class="sidebar-bottom">
      <button class="nav-item" id="helpIcon" data-tip="Dashboard guide" aria-label="Dashboard guide">
        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
      </button>
    ...
    <script>
        ...
        function updateThemeIcon() {{
            ...
            toggle.dataset.tip = isDark ? 'Light mode' : 'Night mode';
        }}
        ...
        $(document).ready(function() {{
            ...
            // Scroll spy
            const sectionIds = ['sectionSummary', 'sectionFilters', 'sectionCharts', 'sectionTable', 'sectionMonthly', 'sectionProjects'];
